...
function Loaded()
{
	...
	imgp.style.backgroundImage = "url('css/images/Opng.png')";
...
function Click(id)
{
	...
	var path = "url('css/images/Opng.png')";
	if (CPlayer == 1) path = "url('css/images/Xpng.png')";
	...
	if (!AI)
	{
		...
		var iplayer = "url('css/images/Opng.png')";
		if (CPlayer == 1) iplayer = "url('css/images/Xpng.png')";
		var imgp = document.getElementById("imgPlayer");
